...
def gen_commands_configs(fold_value, statistic, multi_corr, param, datasets,
    ...
    data_to_params = {
        ...
        'liverm': {
            ...
            'alpha': '0.05'},
        'micro': {
            'samp_var1_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/MINE/Microbiome_fix_500.txt',
            'samp_var2_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/MINE/Microbiome_fix_500.txt',
            'delimiter1': '\\t',
            'delimiter2': '\\t',
            'f1type': 'tidy',
            'f2type': 'tidy',

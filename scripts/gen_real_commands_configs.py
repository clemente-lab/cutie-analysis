...
def gen_commands_configs(fold_value, statistic, multi_corr, param, datasets,
    ...
    data_to_params = {
        ...
        'who': {
            ...
            'alpha': '0.05'},
        'whonous': {
            'samp_var1_fp': '/sc/arion/projects/clemej05a/kevin/data/MINE_data/WHOnous.txt',
            'samp_var2_fp': '/sc/arion/projects/clemej05a/kevin/data/MINE_data/WHOnous.txt',
            'delimiter1': '\\t',
            'delimiter2': '\\t',
            'f1type': 'tidy',
            'f2type': 'tidy',
            ...
            'alpha': '0.05'},
        'covidlong0': {
            'samp_var1_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/covid_long_df_early.txt',
            'samp_var2_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/covid_long_df_early.txt',
            'delimiter1': '\\t',
            'delimiter2': '\\t',
            'f1type': 'tidy',
            'f2type': 'tidy',
            ...
            'alpha': '0.05'},
        'covidlong1': {
            'samp_var1_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/covid_long_df_moderate.txt',
            'samp_var2_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/covid_long_df_moderate.txt',
            'delimiter1': '\\t',
            'delimiter2': '\\t',
            'f1type': 'tidy',
            'f2type': 'tidy',
            ...
            'alpha': '0.05'},
        'covidlong2': {
            'samp_var1_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/covid_long_df_severe.txt',
            'samp_var2_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/covid_long_df_severe.txt',
            'delimiter1': '\\t',
            'delimiter2': '\\t',
            'f1type': 'tidy',
            'f2type': 'tidy',
            ...
            'alpha': '0.05'},
        'covidlongfull': {
            'samp_var1_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/covid_long_df_full.txt',
            'samp_var2_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/covid_long_df_full.txt',
            'delimiter1': '\\t',
            'delimiter2': '\\t',
            'f1type': 'tidy',
            'f2type': 'tidy',
            ...
            'alpha': '0.05'},
        'covidmod': {
            'samp_var1_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/covid_moderate.txt',
            'samp_var2_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/covid_moderate.txt',
            'delimiter1': '\\t',
            'delimiter2': '\\t',
            'f1type': 'tidy',
            'f2type': 'tidy',
            ...
            'alpha': '0.05'},
        'covidsev': {
            'samp_var1_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/covid_severe.txt',
            'samp_var2_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/covid_severe.txt',
            'delimiter1': '\\t',
            'delimiter2': '\\t',
            'f1type': 'tidy',
            'f2type': 'tidy',
        ...
        'hgoral': {
            ...
            'alpha': '0.05'},
        'hgstool': {
            'samp_var1_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/df_stool.txt',
            'samp_var2_fp': '/sc/arion/projects/clemej05a/kevin/cutie_exp/inputs/df_stool.txt',
            'delimiter1': '\\t',
            'delimiter2': '\\t',
            'f1type': 'tidy',
            'f2type': 'tidy',

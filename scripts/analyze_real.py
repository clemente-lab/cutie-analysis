...
def analyze_real(fold_value, statistic, multi_corr, param, datasets,
    ...
    ds_to_titles = {
        ...
        'covid': 'covid',
        'covidlong0': 'covidlong0',
        'covidlong1': 'covidlong1',
        'covidlong2': 'covidlong2',
        'covidlongfull': 'covidlongfull',
        'airplane': 'airplane',
        'ici':'ici',
        'liverf':'liverf',
        'liverm':'liverm',
                            ...
                            for d in datasets:
                                ...
                                # for split jobs
                                    ...
                                    try:
                                        ...
                                        # initialize counters
                                        n_corr, initial_corr, true_corr, false_corr, rs_true, rs_false = 0, 0, 0, 0, 0, 0
                                        ...
                                        for j in split_jobs:
                                            try:
                                                ...
                                                n_corr += len(df) / 2
                                                initial_df = df[df['class'].isin(['TP','FP','TN','FN'])]
